...
print(f"Runs test took {runs_end_time} seconds")
...
# Run: id, weblink, game, category, level, platform, region, players, date, submitted, status, times, videos, comment, splits, values